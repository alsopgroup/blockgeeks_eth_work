...
contract Crowdsale {
    ...
    */
    ...
    function buyTokens(address beneficiary) public payable {
        ...
        // TODO: Your Code Here
        require(!capReached(), "Your Cap Has Been Reached");
        require(beneficiary != address(0), "Must Not Be Address 0");
        uint256 numTokens;
        numTokens = msg.value * rate;
        token.transfer(beneficiary, numTokens);
        weiRaised = weiRaised.add(msg.value);
        emit TokensPurchased(msg.sender, beneficiary, msg.value, numTokens);
